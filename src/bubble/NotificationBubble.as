package bubble
{
	...
	public class NotificationBubble extends SkinnablePopUpContainer
	{
		...
		public function show(owner:DisplayObjectContainer, text:String = ""):void
		{
			...
			//owner.addEventListener(FlexEvent.UPDATE_COMPLETE, onOwnerUpdateComplete_Handler);
			
		}
		private function onOwnerUpdateComplete_Handler(event:FlexEvent):void
		{
			trace("Owner Update Complete Handler");
		...
		override protected function commitProperties():void
		{
			...
			if(isTextChanged)
			{
				...
				if(textLength > minDigits)
				{
					...
					this.width = textLength * label.getStyle('fontSize')//12;
				}
			}
		}
